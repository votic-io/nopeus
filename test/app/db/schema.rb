...
ActiveRecord::Schema.define(version: 20_150_519_173_350) do
  ...
  create_table 'shoppe_application', force: true do |t|
    t.string  'name'
    t.string  'app_token'
  end
  ...
  add_index 'shoppe_stock_level_adjustments', %w(item_id item_type), name: 'index_shoppe_stock_level_adjustments_items'
